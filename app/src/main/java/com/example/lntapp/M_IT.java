...
public class M_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_m);
        b2=(Button)findViewById(R.id.rem_m);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(M_IT.this,"Error",Toast.LENGTH_SHORT).show();
