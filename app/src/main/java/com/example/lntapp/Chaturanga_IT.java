...
public class Chaturanga_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chaturanga__i_t);
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
        listView=findViewById(R.id.chaturanga_list_it);
        Button b1,b2;
        ...
        b1=(Button)findViewById(R.id.OK_cha);
        b2=(Button)findViewById(R.id.rem_cha);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Chaturanga_IT.this,"Error",Toast.LENGTH_SHORT).show();
