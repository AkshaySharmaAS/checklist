...
public class PActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.panini_save);
        c1 = findViewById(R.id.dd_p);
        c2 = findViewById(R.id.psn_p);
        c3 = findViewById(R.id.pp_p);
        c4 = findViewById(R.id.cw_p);
        c5 = findViewById(R.id.md_p);
        c6 = findViewById(R.id.wb_p);
        c7 = findViewById(R.id.as_p);
        c8 = findViewById(R.id.cm_p);
        c9 = findViewById(R.id.sn_p);
        c10 = findViewById(R.id.ps_p);
        c11 = findViewById(R.id.pcr_p);
        c12 = findViewById(R.id.sw_p);
        c13 = findViewById(R.id.ac_p);
        String d1="Y";
        String d2="N";
        text1=findViewById(R.id.name_p);
        text2=findViewById(R.id.remarks_p);
        text3=findViewById(R.id.name_p1);
        text4=findViewById(R.id.remarks_p1);
        Button b2= findViewById(R.id.p_ac);
