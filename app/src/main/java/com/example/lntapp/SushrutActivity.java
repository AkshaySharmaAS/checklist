...
public class SushrutActivity extends AppCompatActivity {
    Button submit1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sushrut);
        Date1= DateFormat.getDateInstance().format(new Date());
        String x="Sushrut"+ " "+ Date1;
        ...
        member= new Member();
        submit1= findViewById(R.id.sushrut_save);
        c1 = findViewById(R.id.dd_s);
        c2 = findViewById(R.id.psn_s);
        c3 = findViewById(R.id.pp_s);
        c4 = findViewById(R.id.cw_s);
        c5 = findViewById(R.id.md_s);
        c6 = findViewById(R.id.wb_s);
        c7 = findViewById(R.id.as_s);
        c8 = findViewById(R.id.cm_s);
        c9 = findViewById(R.id.sn_s);
        c10 = findViewById(R.id.ps_s);
        c11 = findViewById(R.id.pcr_s);
        c12 = findViewById(R.id.sw_s);
        c13 = findViewById(R.id.ac_s);
        String d1="Y";
        String d2="N";
        text1=findViewById(R.id.name_s);
        text2=findViewById(R.id.remarks_s);
        text3=findViewById(R.id.name_s1);
        text4=findViewById(R.id.remarks_s1);
        Button b2= findViewById(R.id.s_ac);
