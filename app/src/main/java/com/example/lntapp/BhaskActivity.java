...
public class BhaskActivity extends AppCompatActivity {
    Button submit1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.bhask_save);
        c1 = findViewById(R.id.dd_bha);
        c2 = findViewById(R.id.psn_bha);
        c3 = findViewById(R.id.pp_bha);
        c4 = findViewById(R.id.cw_bha);
        c5 = findViewById(R.id.md_bha);
        c6 = findViewById(R.id.wb_bha);
        c7 = findViewById(R.id.as_bha);
        c8 = findViewById(R.id.cm_bha);
        c9 = findViewById(R.id.sn_bha);
        c10 = findViewById(R.id.ps_bha);
        c11 = findViewById(R.id.pcr_bha);
        c12 = findViewById(R.id.sw_bha);
        c13 = findViewById(R.id.ac_bha);
        String d1="Y";
        String d2="N";
        text1=findViewById(R.id.name_bha);
        text2=findViewById(R.id.remarks_bha);
        text3=findViewById(R.id.name_bha1);
        text4=findViewById(R.id.remarks_bha1);
        Button b2= findViewById(R.id.bha_ac);
