...
public class Br_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_br);
        b2=(Button)findViewById(R.id.rem_br);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Br_IT.this,"Error",Toast.LENGTH_SHORT).show();
