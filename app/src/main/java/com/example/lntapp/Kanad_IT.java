...
public class Kanad_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_ka);
        b2=(Button)findViewById(R.id.rem_ka);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Kanad_IT.this,"Error",Toast.LENGTH_SHORT).show();
