...
public class P_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_p);
        b2=(Button)findViewById(R.id.rem_p);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(P_IT.this,"Error",Toast.LENGTH_SHORT).show();
