...
public class Kap_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_kap);
        b2=(Button)findViewById(R.id.rem_kap);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Kap_IT.this,"Error",Toast.LENGTH_SHORT).show();
