...
public class Bhaskaracharya_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhaskaracharya__i_t);
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
        listView=findViewById(R.id.bhaskaracharya_list_it);
        Button b1,b2;
        ...
        b1=(Button)findViewById(R.id.OK_bha);
        b2=(Button)findViewById(R.id.rem_bha);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Bhaskaracharya_IT.this,"Error",Toast.LENGTH_SHORT).show();
