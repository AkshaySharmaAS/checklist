...
public class BrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit1= findViewById(R.id.brahm_save);
        c1 = findViewById(R.id.dd_br);
        c2 = findViewById(R.id.psn_br);
        c3 = findViewById(R.id.pp_br);
        c4 = findViewById(R.id.cw_br);
        c5 = findViewById(R.id.md_br);
        c6 = findViewById(R.id.wb_br);
        c7 = findViewById(R.id.as_br);
        c8 = findViewById(R.id.cm_br);
        c9 = findViewById(R.id.sn_br);
        c10 = findViewById(R.id.ps_br);
        c11 = findViewById(R.id.pcr_br);
        c12 = findViewById(R.id.sw_br);
        c13 = findViewById(R.id.ac_br);
        String d1="Y";
        String d2="N";

        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
        text1=findViewById(R.id.name_br);
        text2=findViewById(R.id.remarks_br);
        text3=findViewById(R.id.name_br1);
        text4=findViewById(R.id.remarks_br1);
        Button b2= findViewById(R.id.br_ac);
