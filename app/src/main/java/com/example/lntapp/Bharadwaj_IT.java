...
public class Bharadwaj_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_bh);
        b2=(Button)findViewById(R.id.rem_bh);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Bharadwaj_IT.this,"Error",Toast.LENGTH_SHORT).show();
