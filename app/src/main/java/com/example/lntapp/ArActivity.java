...
public class ArActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.a_save);
        c1 = findViewById(R.id.dd_a);
        c2 = findViewById(R.id.psn_a);
        c3 = findViewById(R.id.pp_a);
        c4 = findViewById(R.id.cw_a);
        c5 = findViewById(R.id.md_a);
        c6 = findViewById(R.id.wb_a);
        c7 = findViewById(R.id.as_a);
        c8 = findViewById(R.id.cm_a);
        c9 = findViewById(R.id.sn_a);
        c10 = findViewById(R.id.ps_a);
        c11 = findViewById(R.id.pcr_a);
        c12 = findViewById(R.id.sw_a);
        c13 = findViewById(R.id.ac_a);
        String d1="Y";
        String d2="N";
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
        text1=findViewById(R.id.name_a);
        text2=findViewById(R.id.remarks_a);
        text3=findViewById(R.id.name_a1);
        text4=findViewById(R.id.remarks_a1);
        Button b2= findViewById(R.id.ar_ac);
