...
public class MActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.m_save);
        c1 = findViewById(R.id.dd_m);
        c2 = findViewById(R.id.psn_m);
        c3 = findViewById(R.id.pp_m);
        c4 = findViewById(R.id.cw_m);
        c5 = findViewById(R.id.md_m);
        c6 = findViewById(R.id.wb_m);
        c7 = findViewById(R.id.as_m);
        c8 = findViewById(R.id.cm_m);
        c9 = findViewById(R.id.sn_m);
        c10 = findViewById(R.id.ps_m);
        c11 = findViewById(R.id.pcr_m);
        c12 = findViewById(R.id.sw_m);
        c13 = findViewById(R.id.ac_m);
        String d1="Y";
        String d2="N";
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
        text1=findViewById(R.id.name_m);
        text2=findViewById(R.id.remarks_m);
        text3=findViewById(R.id.name_m1);
        text4=findViewById(R.id.remarks_m1);
        Button b2= findViewById(R.id.m_ac);
