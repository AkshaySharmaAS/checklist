...
public class VaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.va_save);
        c1 = findViewById(R.id.dd_va);
        c2 = findViewById(R.id.psn_va);
        c3 = findViewById(R.id.pp_va);
        c4 = findViewById(R.id.cw_va);
        c5 = findViewById(R.id.md_va);
        c6 = findViewById(R.id.wb_va);
        c7 = findViewById(R.id.as_va);
        c8 = findViewById(R.id.cm_va);
        c9 = findViewById(R.id.sn_va);
        c10 = findViewById(R.id.ps_va);
        c11 = findViewById(R.id.pcr_va);
        c12 = findViewById(R.id.sw_va);
        c13 = findViewById(R.id.ac_va);
        String d1="Y";
        String d2="N";
        text1=findViewById(R.id.name_va);
        text2=findViewById(R.id.remarks_va);
        text3=findViewById(R.id.name_va1);
        text4=findViewById(R.id.remarks_va1);
        Button b2=findViewById(R.id.va_ac);
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
