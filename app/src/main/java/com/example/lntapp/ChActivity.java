...
public class ChActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.chatur_save);
        c1 = findViewById(R.id.dd_ch);
        c2 = findViewById(R.id.psn_ch);
        c3 = findViewById(R.id.pp_ch);
        c4 = findViewById(R.id.cw_ch);
        c5 = findViewById(R.id.md_ch);
        c6 = findViewById(R.id.wb_ch);
        c7 = findViewById(R.id.as_ch);
        c8 = findViewById(R.id.cm_ch);
        c9 = findViewById(R.id.sn_ch);
        c10 = findViewById(R.id.ps_ch);
        c11 = findViewById(R.id.pcr_ch);
        c12 = findViewById(R.id.sw_ch);
        c13 = findViewById(R.id.ac_ch);
        String d1="Y";
        String d2="N";
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
        text1=findViewById(R.id.name_cha);
        text2=findViewById(R.id.remarks_cha);
        text3=findViewById(R.id.name_cha1);
        text4=findViewById(R.id.remarks_cha1);
        Button b2= findViewById(R.id.cha_ac);
