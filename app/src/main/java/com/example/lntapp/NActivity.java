...
public class NActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.n_save);
        c1 = findViewById(R.id.dd_n);
        c2 = findViewById(R.id.psn_n);
        c3 = findViewById(R.id.pp_n);
        c4 = findViewById(R.id.cw_n);
        c5 = findViewById(R.id.md_n);
        c6 = findViewById(R.id.wb_n);
        c7 = findViewById(R.id.as_n);
        c8 = findViewById(R.id.cm_n);
        c9 = findViewById(R.id.sn_n);
        c10 = findViewById(R.id.ps_n);
        c11 = findViewById(R.id.pcr_n);
        c12 = findViewById(R.id.sw_n);
        c13 = findViewById(R.id.ac_n);
        text1=findViewById(R.id.name_n);
        text2=findViewById(R.id.remarks_n);
        text3=findViewById(R.id.name_n1);
        text4=findViewById(R.id.remarks_n1);
        Button b2= findViewById(R.id.n_ac);
        String d1="Y";
        String d2="N";
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
