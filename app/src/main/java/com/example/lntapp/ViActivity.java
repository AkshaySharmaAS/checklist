...
public class ViActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.vi_save);
        c1 = findViewById(R.id.dd_vi);
        c2 = findViewById(R.id.psn_vi);
        c3 = findViewById(R.id.pp_vi);
        c4 = findViewById(R.id.cw_vi);
        c5 = findViewById(R.id.md_vi);
        c6 = findViewById(R.id.wb_vi);
        c7 = findViewById(R.id.as_vi);
        c8 = findViewById(R.id.cm_vi);
        c9 = findViewById(R.id.sn_vi);
        c10 = findViewById(R.id.ps_vi);
        c11 = findViewById(R.id.pcr_vi);
        c12 = findViewById(R.id.sw_vi);
        c13 = findViewById(R.id.ac_vi);
        String d1="Y";
        String d2="N";
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
        text1=findViewById(R.id.name_vi);
        text2=findViewById(R.id.remarks_vi);
        text3=findViewById(R.id.name_vi1);
        text4=findViewById(R.id.remarks_vi1);
        Button b2= findViewById(R.id.vi_ac);
