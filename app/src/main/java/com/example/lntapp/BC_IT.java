...
public class BC_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_bc);
        b2=(Button)findViewById(R.id.rem_bc);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BC_IT.this,"Error",Toast.LENGTH_SHORT).show();
