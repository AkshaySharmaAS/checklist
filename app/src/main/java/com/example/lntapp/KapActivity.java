...
public class KapActivity extends AppCompatActivity {
    Button submit1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.kp_save);
        c1 = findViewById(R.id.dd_kp);
        c2 = findViewById(R.id.psn_kp);
        c3 = findViewById(R.id.pp_kp);
        c4 = findViewById(R.id.cw_kp);
        c5 = findViewById(R.id.md_kp);
        c6 = findViewById(R.id.wb_kp);
        c7 = findViewById(R.id.as_kp);
        c8 = findViewById(R.id.cm_kp);
        c9 = findViewById(R.id.sn_kp);
        c10 = findViewById(R.id.ps_kp);
        c11 = findViewById(R.id.pcr_kp);
        c12 = findViewById(R.id.sw_kp);
        c13 = findViewById(R.id.ac_kp);
        String d1="Y";
        String d2="N";
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
        text1=findViewById(R.id.name_kp);
        text2=findViewById(R.id.remarks_kp);
        text3=findViewById(R.id.name_kp1);
        text4=findViewById(R.id.remarks_kp1);
        Button b2= findViewById(R.id.kap_ac);
