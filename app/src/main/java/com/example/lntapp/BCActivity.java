...
public class BCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String x="Browsing Centre"+ " "+ Date1;
        ...
        member= new Member();
        submit1= findViewById(R.id.bc_save);
        c1 = findViewById(R.id.dd_bc);
        c2 = findViewById(R.id.psn_bc);
        c3 = findViewById(R.id.pp_bc);
        c4 = findViewById(R.id.cw_bc);
        c5 = findViewById(R.id.md_bc);
        c6 = findViewById(R.id.wb_bc);
        c7 = findViewById(R.id.as_bc);
        c8 = findViewById(R.id.cm_bc);
        c9 = findViewById(R.id.sn_bc);
        c10 = findViewById(R.id.ps_bc);
        c11 = findViewById(R.id.pcr_bc);
        c12 = findViewById(R.id.sw_bc);
        c13 = findViewById(R.id.ac_bc);
        String d1="Y";
        String d2="N";
        text1=findViewById(R.id.name_bc);
        text2=findViewById(R.id.remarks_bc);
        text3=findViewById(R.id.name_bc1);
        text4=findViewById(R.id.remarks_bc1);
        Button b2=findViewById(R.id.bc_ac);
