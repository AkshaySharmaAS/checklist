...
public class KaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.k_save);
        c1 = findViewById(R.id.dd_k);
        c2 = findViewById(R.id.psn_k);
        c3 = findViewById(R.id.pp_k);
        c4 = findViewById(R.id.cw_k);
        c5 = findViewById(R.id.md_k);
        c6 = findViewById(R.id.wb_k);
        c7 = findViewById(R.id.as_k);
        c8 = findViewById(R.id.cm_k);
        c9 = findViewById(R.id.sn_k);
        c10 = findViewById(R.id.ps_k);
        c11 = findViewById(R.id.pcr_k);
        c12 = findViewById(R.id.sw_k);
        c13 = findViewById(R.id.ac_k);
        String d1="Y";
        String d2="N";
        text1=findViewById(R.id.name_k);
        text2=findViewById(R.id.remarks_k);
        text3=findViewById(R.id.name_k1);
        text4=findViewById(R.id.remarks_k1);
        Button b2= findViewById(R.id.ka_ac);
