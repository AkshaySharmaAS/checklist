...
public class BhActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member= new Member();
        submit1= findViewById(R.id.bharad_save);
        c1 = findViewById(R.id.dd_bh);
        c2 = findViewById(R.id.psn_bh);
        c3 = findViewById(R.id.pp_bh);
        c4 = findViewById(R.id.cw_bh);
        c5 = findViewById(R.id.md_bh);
        c6 = findViewById(R.id.wb_bh);
        c7 = findViewById(R.id.as_bh);
        c8 = findViewById(R.id.cm_bh);
        c9 = findViewById(R.id.sn_bh);
        c10 = findViewById(R.id.ps_bh);
        c11 = findViewById(R.id.pcr_bh);
        c12 = findViewById(R.id.sw_bh);
        c13 = findViewById(R.id.ac_bh);
        String d1="Y";
        String d2="N";
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
        text1=findViewById(R.id.name_bh);
        text2=findViewById(R.id.remarks_bh);
        text3=findViewById(R.id.name_bh1);
        text4=findViewById(R.id.remarks_bh1);

        Button b2= findViewById(R.id.bh_ac);
