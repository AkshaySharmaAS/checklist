...
public class Sushrut_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_s);
        b2=(Button)findViewById(R.id.rem_s);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Sushrut_IT.this,"Error",Toast.LENGTH_SHORT).show();
