...
public class Va_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_va);
        b2=(Button)findViewById(R.id.rem_va);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Va_IT.this,"Error",Toast.LENGTH_SHORT).show();
