...
public class Vi_IT extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.OK_vi);
        b2=(Button)findViewById(R.id.rem_vi);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Vi_IT.this,"Error",Toast.LENGTH_SHORT).show();
