...
public class CharakAct extends AppCompatActivity {
      Button submit1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_charak);
        ...
        member= new Member();
        submit1= findViewById(R.id.charak_save);
        c1 = findViewById(R.id.dd);
        c2 = findViewById(R.id.psn);
        c3 = findViewById(R.id.pp);
        c4 = findViewById(R.id.cw);
        c5 = findViewById(R.id.md);
        c6 = findViewById(R.id.wb);
        c7 = findViewById(R.id.as);
        c8 = findViewById(R.id.cm);
        c9 = findViewById(R.id.sn);
        c10 = findViewById(R.id.ps);
        c11 = findViewById(R.id.pcr);
        c12 = findViewById(R.id.sr);
        c13 = findViewById(R.id.ac);
         text1=findViewById(R.id.name_c);
         text2=findViewById(R.id.remarks_c);
        text3=findViewById(R.id.name_c1);
        text4=findViewById(R.id.remarks_c1);
        Button b2= findViewById(R.id.ch_ac);
        String d1="Y";
        String d2="N";
        dateFormat=new SimpleDateFormat("EEE, MMM d, ''yy");
        Date1= DateFormat.getDateInstance().format(new Date());
